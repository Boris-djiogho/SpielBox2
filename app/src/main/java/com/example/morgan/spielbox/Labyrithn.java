...
public class Labyrithn extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_labyrithn);
    ...
    public static class GameView extends View {
        ...
        public GameView(Context context) {
            ...
            random = new Random();
            spielerFarbe = new Paint();
            rausFarbe = new Paint();
            spielerFarbe.setColor(Color.GREEN);
            rausFarbe.setColor(Color.RED);
            CreateMaze();
